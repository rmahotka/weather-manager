...
.main {
  ...
  background: linear-gradient(
    37deg,
    rgba(191, 88, 228, 0.6474964985994398) 0%,
    rgba(136, 34, 195, 0.6951155462184874) 54%,
    rgba(45, 129, 253, 0.6418942577030813) 100%
  );
}
</style>
